        ...
        <header className="bg-white hidden md:block sticky top-0 z-10">
            <nav className="flex justify-between items-center mx-12 xxl:m-auto py-4 max-w-page">
                ...
                <div className="flex items-center xl:min-w-[400px] w-1/3">
                    ...
                    {/* LOGO */}
                    <NavLink to="/" className="cursor-pointer w-[98px]">
                        <img
                            src={VeloLogo}
                            alt="Velo"
                            width="96"
                ...
                <div className="w-1/3 flex justify-end">
                    ...
                    {user ? (
                        <div ref={menuRef} className="relative">
                            ...
                            >
                                <img
                                    src="https://playo-website.gumlet.io/playo-website-v3/icons/Avatar-man-specs.png?q=30"
                                    alt={user.name || "User"}
                            ...
                            {openMenu && (
                                <div
                                    className="absolute right-0 top-12 z-30 w-40 bg-white border rounded-lg shadow-lg divide-y"
                                >
